  ...
  return (
    <CardContainer>
      ...
      <CardBody>
        ...
        <CardText>
          <p>
            Explain how you encountered the problem you’re trying to solve, and any difficulties
    ...
    <CardContainer>
      ...
      <CardBody>
        ...
        <CardText>
          ...
          <p>
            Not all questions benefit from including code, but if your problem is better understood
            with code you’ve written, you should include a minimal, reproducible example.
          </p>
          <p>
            Please make sure to post code and errors as text directly to the question (and not as
            images), and format them appropriately.
          </p>
        </CardText>
      </CardBody>
    </CardContainer>
